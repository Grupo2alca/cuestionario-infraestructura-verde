...
answers = [
    ...
    "Techos verdes, pavimentos permeables, jardines de lluvia...",
    "Es la combinación de infraestructuras tradicionales con soluciones naturales...",
    "Jardines de lluvia, zanjas de infiltración, pavimentos permeables...",
    "Reducen el volumen de escorrentía, mejoran la calidad del agua...",
    "Es una herramienta que simula el comportamiento del agua en cuencas o sistemas urbanos...",
    "Datos temporales (lluvia, caudal, evaporación), espaciales (uso de suelo)...",
    ...
    "Porque su inclusión mejora la aceptación social, sostenibilidad...",
    "La gobernanza proporciona políticas, normas y guías técnicas...",
    "Existen barreras culturales, financieras, institucionales...",
    "Es un proceso participativo donde ciudadanos, técnicos, académicos y autoridades colaboran...",
    "Son métricas que miden la apertura y el nivel de participación ciudadana...",
    "Es una herramienta económica que compara los beneficios totales con los costos...",
    ...
    "Permite evaluar no solo la inversión inicial, sino también los costos de operación...",
    "Falta de financiamiento, prioridades en obras tradicionales...",
    "Porque indica la calidad del agua, esencial para evaluar el estado ecológico...",
    "Según la Directiva de Aguas para Peces, para aguas salmonídeas se recomienda ≤0.2 mg/L...",
    "Es un parámetro que representa la fracción de precipitación que se convierte en escorrentía...",
    "A través de la temperatura equivalente fisiológica (PET)...",
    "Nivel de agua, tasa de flujo, sólidos suspendidos, nitrógeno total...",
    "Aún existen barreras como políticas deficientes, escaso conocimiento...",
    "Se concluyó que las zanjas verdes fueron las más rentables individualmente...",
    "El municipio ha incluido normativas para la planificación con infraestructura azul-verde...",
    "Zanjas verdes, barriles de lluvia y estanques secos fueron los más costo-efectivos...",
    "Se alcanzó una reducción del 56% en daños por inundaciones gracias a techos verdes...",
    "Mayor riesgo de deslizamientos, falta de planificación urbana...",
    "Porque permite entender su desempeño real, justificar su implementación...",
    "La planificación urbana estratégica debe integrar soluciones naturales como GIs...",
    "Las políticas proporcionan el marco legal, normativo y técnico necesario...",
    "Permite recopilar datos para mejorar decisiones futuras...",
    "Gestión de drenaje urbano, 2) Urbanización, 3) Cambio climático...",
    "El criterio de 'Gestión de drenaje urbano', que incluye indicadores como escorrentía...",
    "El de 'Participación social y de actores', ya que promueve procesos inclusivos...",
    "Es el proceso de transformar zonas urbanas degradadas en espacios habitables...",
    "Se usan indicadores estructurales, de proceso y de resultados..."
]

# Función para crear la app en Streamlit
def app():
    st.title("Cuestionario sobre Infraestructura Verde (GI)")
    
    # Crear un formulario de preguntas y respuestas
    respuestas_usuario = []
    
    for i, question in enumerate(questions):
        st.subheader(question)
        respuesta = st.text_input(f"Tu respuesta a la pregunta {i+1}")
